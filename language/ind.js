...
exports.noregis = () => {
	return`*「 BELUM DAFTAR 」*\n\n*Maaf anda belum terdaftar sebagai teman YXU BOT*\n*Silahkan daftar dulu dengan contoh yang tertera*\n\n*Cara daftar ${prefix}daftar nama|umur* \n*contoh ${prefix}daftar YXU|17*`
}
...
├ ${prefix}ttp *_text_*
├ ${prefix}quotemaker *_text|author_*
├ ${prefix}qrcode *_text_*
├ ${prefix}stickerhide *_text_*
├ ${prefix}emoji
╰────[ *MAKER MENU* ]────
...
𝑵𝑶𝑻𝑬 : 
*Di karenakan BOT ini gratis, Tolong jangan spam ya sayang*
