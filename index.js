...
limitawal = 30
memberlimit = 0
cr = '𝙔𝙓𝙐 𝘽𝙊𝙏 *_SUDAH TERVERIFIKASI_*'
/*************************************/

/******** OWNER NUMBER**********/
const ownerNumber = ["6281373323199@s.whatsapp.net","6281977578791@s.whatsapp.net"] 
/************************************/
            ...
            const latensi = speed() - timestamp
               ...
               case 'help': 
         	   ...
         	   case 'creator':
                  ...
                  client.sendMessage(from, 'Langsung save aja ngab owner nya gans:v',MessageType.text, { quoted: mek} )
					break    
				case 'leaderboard':
				case 'lb':
				bo = args[0]
...
• Limit: ${limitawal-updated.limit}`
           ...
           case 'demote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`𝘆𝗮𝗵𝗵 @${mentioned[0].split('@')[0]} *jabatan* 𝗮𝗱𝗺𝗶𝗻 𝗸𝗮𝗺𝘂 *sudah* 𝗱𝗶 𝗰𝗼𝗽𝗼𝘁🏃`, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					}
					break
				case 'promote':
					...
					if (!isGroupAdmins) return reply(ind.admin())
					if (!isBotGroupAdmins) return reply(ind.badmin())
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('𝗧𝗮𝗴 𝘁𝗮𝗿𝗴𝗲𝘁 *yang* 𝗶𝗻𝗴𝗶𝗻 *di* 𝘁𝗲𝗻𝗱𝗮𝗻𝗴!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
